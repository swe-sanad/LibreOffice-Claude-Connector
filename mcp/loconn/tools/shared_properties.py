...
from .calc_analysis import _CALC_ERRORS   # error-code -> message, for the Calc scan
...
register(globals(), TOOL_DEFS,
         basic=['document_lifecycle', 'print_settings', 'set_alt_text', 'set_document_properties', 'diagnose_document'],
         read_only=['document_lifecycle', 'get_document_properties', 'get_signatures', 'list_styles', 'print_settings', 'set_view_zoom', 'diagnose_document'])
